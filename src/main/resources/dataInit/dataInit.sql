...
values (1, 1, 'AVG', 'Karakol', 'KGTU'),
       ...
       (7, 7, 'AVG', 'Osh', 'OSHGU'),
       (8, 8, 'AVG', 'Osh', 'OSHGU'),
       (9, 9, 'HIGHER', 'Tokmok', 'KGTU'),
       (10, 10, 'AVG', 'Talas', 'MANAS'),
       (11, 11, 'HIGHER', 'Karakol', 'KGMA'),
       (12, 12, 'AVG', 'Jalal-Abad', 'OSHGU'),
       (13, 13, 'HIGHER', 'Bishkek', 'KSUCTA'),
       (14, 14, 'AVG', 'Naryn', 'KNU'),
       (15, 15, 'AVG', 'Bishkek', 'KRSU'),
       (16, 16, 'HIGHER', 'Tashkent', 'TUIT'),
       (17, 17, 'AVG', 'Osh', 'KSUCTA'),
       (18, 18, 'HIGHER', 'Bishkek', 'KSTU'),
       (19, 19, 'AVG', 'Bishkek', 'KNURE'),
       (20, 20, 'HIGHER', 'Bishkek', 'KRSU');
...
>>>>>>> 65a066ab31e222b2760684351bd5f0705e054e23
