...
values (1, 1, 'КЫРГЫЗСТАН', 'Karakol', 'KGTU'),
       (2, 1, 'КЫРГЫЗСТАН', 'Bishkek', 'KGTU'),
       (3, 2, 'КЫРГЫЗСТАН', 'Naryn', 'PED'),
       (4, 2, 'КЫРГЫЗСТАН', 'Bishkek', 'AUSA'),
       (5, 3, 'КЫРГЫЗСТАН', 'Bishkek', 'MANAS'),
       (6, 4, 'КЫРГЫЗСТАН', 'Naryn', 'USA'),
       (7, 4, 'КЫРГЫЗСТАН', 'Osh', 'OSHGU'),
       (8, 5, 'КЫРГЫЗСТАН', 'Osh', 'OSHGU'),
       (9, 6, 'КЫРГЫЗСТАН', 'Tokmok', 'KGTU'),
       (10, 7, 'КЫРГЫЗСТАН', 'Talas', 'MANAS'),
       (11, 7, 'КЫРГЫЗСТАН', 'Karakol', 'KGMA'),
       (12, 8, 'КЫРГЫЗСТАН', 'Jalal-Abad', 'OSHGU'),
       (13, 8, 'КЫРГЫЗСТАН', 'Bishkek', 'KSUCTA'),
       (14, 9, 'КЫРГЫЗСТАН', 'Naryn', 'KNU'),
       (15, 9, 'КЫРГЫЗСТАН', 'Bishkek', 'KRSU'),
       (16, 10, 'КЫРГЫЗСТАН', 'Tashkent', 'TUIT'),
       (17, 11, 'КЫРГЫЗСТАН', 'Osh', 'KSUCTA'),
       (18, 12, 'КЫРГЫЗСТАН', 'Bishkek', 'KSTU'),
       (19, 13, 'КЫРГЫЗСТАН', 'Bishkek', 'KNURE'),
       (20, 14, 'КЫРГЫЗСТАН', 'Bishkek', 'KRSU');
